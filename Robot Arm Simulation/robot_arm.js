...
window.onload = function init() {
  ...
  // p = ortho(-5.0, 5.0,-5.0, 5.0, 1.0, 20.0);
...
function render() {
	...
	var type = gl.LINE_STRIP;
	var start = wireCubeStart;
	var num  = wireCubeVertices;
	
	if (solidCube == true) {
		type = gl.TRIANGLES;
		start = solidCubeStart;
		num = solidCubeVertices;
	}
...
//////// Student modified code below: ////////////
		matStack.push(mv);
		//Position Finger1.1 Joint
		mv = mult(mv, translate(1.0, 0.2, 0.4));
		//Finger Joint
		mv = mult(mv, rotateZ(finger+30));
		//Position Finger1.1 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Finger1.1
		matStack.push(mv);
		...
		//Position Finger1.2 Joint
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Finger Joint
		mv = mult(mv, rotateZ(-30));
		//Position Finger1.2 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Finger1.2
		matStack.push(mv);
			mv = mult(mv, scale(0.5, 0.2, 0.2));
			gl.uniformMatrix4fv(mvLoc, gl.FALSE, flatten(mv));
			gl.drawArrays(type, start, num);
		...
		//Position Finger2.1 Joint
		mv = mult(mv, translate(1.0, 0.2, 0.0));
		//Finger Joint
		mv = mult(mv, rotateZ(finger + 30));
		//Position Finger2.1 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Finger2.1
		matStack.push(mv);
			mv = mult(mv, scale(0.5, 0.2, 0.2));
			gl.uniformMatrix4fv(mvLoc, gl.FALSE, flatten(mv));
			gl.drawArrays(type, start, num);
		...
		//Position Finger2.2 Joint
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Finger Joint
		mv = mult(mv, rotateZ(-30));
		//Position Finger2.2 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Finger2.2
		matStack.push(mv);
			mv = mult(mv, scale(0.5, 0.2, 0.2));
			gl.uniformMatrix4fv(mvLoc, gl.FALSE, flatten(mv));
			gl.drawArrays(type, start, num);
		...
		//Position Finger3.1 Joint
		mv = mult(mv, translate(1.0, 0.2, -0.4));
		//Finger Joint
		mv = mult(mv, rotateZ(finger+30));
		//Position Finger3.1 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Finger3.1
		matStack.push(mv);
			mv = mult(mv, scale(0.5, 0.2, 0.2));
			gl.uniformMatrix4fv(mvLoc, gl.FALSE, flatten(mv));
			gl.drawArrays(type, start, num);
		...
		//Position Finger3.2 Joint
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Finger Joint
		mv = mult(mv, rotateZ(-30));
		//Position Finger3.2 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Finger3.2
		matStack.push(mv);
			mv = mult(mv, scale(0.5, 0.2, 0.2));
			gl.uniformMatrix4fv(mvLoc, gl.FALSE, flatten(mv));
			gl.drawArrays(type, start, num);
		...
		//Position Thumb.1 Joint
		mv = mult(mv, translate(1.0, -0.2, 0.4));
		//Thumb Joint
		mv = mult(mv, rotateZ(-finger - 45));
		//Position Thumb.1 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Thumb.1
		matStack.push(mv);
			mv = mult(mv, scale(0.5, 0.2, 0.2));
			gl.uniformMatrix4fv(mvLoc, gl.FALSE, flatten(mv));
			gl.drawArrays(type, start, num);
		...
		//Position Thumb.2 Joint
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Thumb Joint
		mv = mult(mv, rotateZ(45));
		//Position Thumb.2 Cube
		mv = mult(mv, translate(0.25, 0.0, 0.0));
		//Scale and Draw Thumb.2
		matStack.push(mv);
			mv = mult(mv, scale(0.5, 0.2, 0.2));
			gl.uniformMatrix4fv(mvLoc, gl.FALSE, flatten(mv));
			gl.drawArrays(type, start, num);
